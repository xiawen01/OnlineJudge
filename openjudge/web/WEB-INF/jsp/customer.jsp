...
<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation"
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="<%=basePath%>problem/list.action">BOOT客户管理系统 v2.0</a>
		</div>
		<!-- 导航栏右侧图标部分 -->
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<a href="${pageContext.request.contextPath }/problem/list.action" class="active">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get"
					  action="${pageContext.request.contextPath }/problem/list.action">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="col-md-12 text-right">
						<itheima:page url="${pageContext.request.contextPath }/problem/list.action" />
					</div>
					<!-- /.panel-body -->
				</div>
				<!-- /.panel -->
...
<script type="text/javascript">
    ...
    function createCustomer() {
        $.post("<%=basePath%>problem/create.action",
    ...
    function editCustomer(id) {
        $.ajax({
            type:"get",
            url:"<%=basePath%>problem/getCustomerById.action",
            data:{"id":id},
    ...
    function updateCustomer() {
        $.post("<%=basePath%>problem/update.action",$("#edit_customer_form").serialize(),function(data){
            if(data =="OK"){
                alert("客户信息更新成功！");
                window.location.reload();
            }else{
    ...
    function deleteCustomer(id) {
        if(confirm('确实要删除该客户吗?')) {
            $.post("<%=basePath%>problem/delete.action",{"id":id},
                function(data){
                    if(data =="OK"){
                        alert("客户删除成功！");
                        window.location.reload();
